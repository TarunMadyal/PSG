...
class _CartPanelState extends ConsumerState<CartPanel> {
  ...
  Future<void> _checkout() async {
    ...
    // Whether this is a GST bill is decided by Settings (GST number configured
    // + payment method + "Print GST on cash bills"), not per-sale in billing.
    final shop = ref.read(shopProfileProvider).valueOrNull;
    final isGst = shop?.shouldPrintGst(cart.paymentMethod) ?? false;
